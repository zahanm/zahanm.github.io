...
var TagStyles = {
  'h1': { size: 18, before: 0.75, after: 0.25 },
  'h2': { size: 17, before: 0.75, after: 0.25 },
  'h3': { size: 16, before: 0.5, after: 0.25 },
  'h4': { size: 15, before: 0.5, after: 0.25 },
  'h5': { size: 13, before: 0.5, after: 0.25 },
  'h6': { size: 12, before: 0.5, after: 0.25 },
  'p': { size: 10, before: 0.25, after: 0.25, color: '#000' }
}
...
function resume(finished) {
  fs.readFile(path.join(__dirname, '../static/old-resume.html'), function (err, contents) {
